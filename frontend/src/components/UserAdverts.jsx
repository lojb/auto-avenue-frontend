        ...
        <div className="grid grid-cols-2 gap-4">
            {adverts && adverts.length === 0 &&
                <div>
                    ...
                    <Link to={"/create"}>
                        <button
                            className="px-4 py-2 rounded-md bg-blue-600 text-white font-medium hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-opacity-50"
                        >
                            Create
                        </button>
                    </Link>
